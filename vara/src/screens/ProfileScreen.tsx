...
export const ProfileScreen: React.FC<ProfileScreenProps> = ({ onLogout }) => {
  ...
  const profileFields = [
    { label: 'Age', value: `${currentUser.age} years old`, icon: 'person-outline' as const },
    { label: 'Time Trying', value: currentUser.timeTrying, icon: 'time-outline' as const },
    { label: 'Diagnosis', value: currentUser.diagnosis, icon: 'medical-outline' as const },
    { label: 'Treatment Stage', value: currentUser.treatmentStage, icon: 'flask-outline' as const },
    { label: 'Clinic', value: currentUser.clinic, icon: 'business-outline' as const },
    { label: 'Doctor', value: currentUser.doctor, icon: 'people-outline' as const },
    { label: 'Partner', value: currentUser.partner, icon: 'heart-outline' as const },
  ];
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.profileHeader}>
            ...
            <View style={styles.treatmentBadge}>
              ...
              <Text style={styles.treatmentBadgeText}>{currentUser.treatmentStage}</Text>
            </View>
          </View>
